...
import { IAchievementIconResponse } from './AchievementIcon.class';
...
export class AchievementIconsResource {
    private common: Common<IAchievementIconResponse>;
     ...
     */
    public getAll(userOpts?): Promise<IAchievementIconResponse[]> {
     ...
     */
    public remove(iconFileName: string, userOpts?): Promise<IAchievementIconResponse> {
